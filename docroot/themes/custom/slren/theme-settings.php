...
function slren_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'slren/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_text'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_text','slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (slren/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['color_scheme'] = array(
    ...
    '#default_value' => theme_get_setting('color_scheme', 'slren'),
    '#options' => array(
    'blue' => t('Blue'),
    'khaki' => t('Khaki Grey'),
    'gold' => t('Gold Loulou'),
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['page_container_border'] = array(
    ...
    '#default_value' => theme_get_setting('page_container_border', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['animations_state'] = array(
    ...
    '#default_value' => theme_get_setting('animations_state', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['slideout']['slideout_background_color'] = array(
    ...
    '#default_value' => theme_get_setting('slideout_background_color', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['regions_tab']['regions']['slideout']['slideout_side'] = array(
    ...
    '#default_value' => theme_get_setting('slideout_side', 'slren'),
    '#options' => array(
    'left' => t('Left'),
    'right' => t('Right'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['slideout']['slideout_touch_swipe'] = array(
    ...
    '#default_value' => theme_get_setting('slideout_touch_swipe', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['slideout']['slideout_blocks_paddings'] = array(
    ...
    '#default_value' => theme_get_setting('slideout_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['slideout']['slideout_region_paddings'] = array(
    ...
    '#default_value' => theme_get_setting('slideout_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top_highlighted']['header_top_highlighted_layout_container'] = array(
    ...
    '#default_value' => theme_get_setting('header_top_highlighted_layout_container', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top_highlighted']['header_top_highlighted_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('header_top_highlighted_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top_highlighted']['header_top_highlighted_animation_effect'] = array(
    ...
    '#default_value' => theme_get_setting('header_top_highlighted_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top_highlighted']['header_top_highlighted_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('header_top_highlighted_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top_highlighted']['header_top_highlighted_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('header_top_highlighted_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top']['header_top_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('header_top_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top']['header_top_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('header_top_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top']['header_top_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('header_top_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top']['header_top_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('header_top_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header_top']['header_top_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('header_top_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header']['header_layout_container'] = array(
    ...
    '#title' => t('Container'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('header_layout_container', 'slren'),
    '#options' => array(
    'container-fluid' => t('Full Width'),
    'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header']['header_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('header_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['header']['fixed_header'] = array(
    ...
    '#default_value' => theme_get_setting('fixed_header', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header']['header_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('header_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['header']['header_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('header_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['banner']['banner_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('banner_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['banner']['banner_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('banner_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['banner']['banner_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('banner_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['banner']['banner_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('banner_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top']['content_top_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('content_top_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top']['content_top_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('content_top_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top']['content_top_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('content_top_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top']['content_top_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('content_top_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top']['content_top_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('content_top_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('content_top_highlighted_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_separator'] = array(
    ...
    '#default_value' => theme_get_setting('content_top_highlighted_separator', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('content_top_highlighted_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('content_top_highlighted_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('content_top_highlighted_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_top_highlighted']['content_top_highlighted_region_paddings'] = array(
    ...
    '#default_value' => theme_get_setting('content_top_highlighted_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['main_content']['main_content_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('main_content_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['main_content']['main_content_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('main_content_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['main_content']['main_content_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('main_content_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['main_content']['main_content_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('main_content_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_first']['sidebar_first_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('sidebar_first_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_first']['sidebar_first_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('sidebar_first_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_first']['sidebar_first_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('sidebar_first_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_second']['sidebar_second_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('sidebar_second_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_second']['sidebar_second_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('sidebar_second_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sidebar_second']['sidebar_second_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region.'),
    '#default_value' => theme_get_setting('sidebar_second_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('content_bottom_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('content_bottom_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('content_bottom_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('content_bottom_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('content_bottom_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['content_bottom']['content_bottom_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('content_bottom_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('featured_top_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('featured_top_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('featured_top_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('featured_top_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('featured_top_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_top']['featured_top_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('featured_top_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('featured_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('featured_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('featured_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('featured_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('featured_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured']['featured_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('featured_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('featured_bottom_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('featured_bottom_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('featured_bottom_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('featured_bottom_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('featured_bottom_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['featured_bottom']['featured_bottom_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('featured_bottom_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('sub_featured_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('sub_featured_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('sub_featured_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('sub_featured_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('sub_featured_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['sub_featured']['sub_featured_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('sub_featured_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('highlighted_top_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('highlighted_top_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('highlighted_top_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('highlighted_top_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('highlighted_top_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted_top']['highlighted_top_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('highlighted_top_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('highlighted_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('highlighted_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('highlighted_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('highlighted_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('highlighted_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['highlighted']['highlighted_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('highlighted_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('footer_top_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('footer_top_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('footer_top_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('footer_top_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('footer_top_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_top']['footer_top_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('footer_top_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('footer_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('footer_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('footer_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_animation_effect'] = array(
    ...
    '#title' => t('Animation Effect'),
    '#description'   => t('From the drop-down menu, select the animation effect you prefer.'),
    '#default_value' => theme_get_setting('footer_animation_effect', 'slren'),
    '#options' => array(
    'no-animation' => t('None'),
    'fadeIn' => t('Fade In'),
    'fadeInDown' => t('Fade In Down'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('footer_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer']['footer_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('footer_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_bottom']['footer_bottom_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('footer_bottom_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_bottom']['footer_bottom_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('footer_bottom_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_bottom']['footer_bottom_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('footer_bottom_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_bottom']['footer_bottom_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('footer_bottom_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['footer_bottom']['footer_bottom_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('footer_bottom_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['subfooter']['subfooter_layout_container'] = array(
    ...
    '#title' => t('Layout Mode'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#default_value' => theme_get_setting('subfooter_layout_container', 'slren'),
    '#options' => array(
      'container-fluid' => t('Full Width'),
      'container' => t('Fixed Width'),
    ),
  ...
  $form['mtt_settings']['regions_tab']['regions']['subfooter']['subfooter_separator'] = array(
    ...
    '#title' => t('Separator'),
    '#description'   => t('From the drop-down menu, select the separator you prefer. The separator will be applied between the current region and the one above.'),
    '#default_value' => theme_get_setting('subfooter_separator', 'slren'),
    '#options' => array(
    'region--no-separator' => t('Default'),
    'region--separator-incline-diagonal' => t('Ιncline Diagonal Separator'),
    'region--separator-decline-diagonal' => t('Decline Diagonal Separator'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['subfooter']['subfooter_background_color'] = array(
    ...
    '#title' => t('Background Color'),
    '#description'   => t('From the drop-down menu, select the background color you prefer.'),
    '#default_value' => theme_get_setting('subfooter_background_color', 'slren'),
    '#options' => array(
    'region--dark-typography region--white-background' => t('White'),
    'region--dark-typography region--white-background region--white-pattern' => t('White Pattern'),
    'region--dark-typography region--gray-background' => t('Light Gray'),
  ...
  $form['mtt_settings']['regions_tab']['regions']['subfooter']['subfooter_blocks_paddings'] = array(
    ...
    '#title' => t('Remove whitespace between blocks'),
    '#description'   => t('Use this checkbox to remove the padding between blocks assigned in this region.'),
    '#default_value' => theme_get_setting('subfooter_blocks_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['subfooter']['subfooter_region_paddings'] = array(
    ...
    '#title' => t('Remove top and bottom region whitespace'),
    '#description'   => t('Use this checkbox to remove the top and bottom paddings of the region. Please leave this option disabled if you also select a region seperator other than "Default" from the available options above.'),
    '#default_value' => theme_get_setting('subfooter_region_paddings', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['reading_time'] = array(
    ...
    '#default_value' => theme_get_setting('reading_time', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['font_resize'] = array(
    ...
    '#default_value' => theme_get_setting('font_resize', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['post_progress'] = array(
    ...
    '#default_value' => theme_get_setting('post_progress', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['affix_side'] = array(
    ...
    '#default_value' => theme_get_setting('affix_side', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['share_links'] = array(
    ...
    '#default_value' => theme_get_setting('share_links', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['post_tab']['post']['print_button'] = array(
    ...
    '#default_value' => theme_get_setting('print_button', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['layout_tab']['layout_modes']['layout_mode'] = array(
    ...
    '#default_value' => theme_get_setting('layout_mode', 'slren'),
    '#options' => array(
      'wide' => t('Wide'),
      'boxed' => t('Boxed'),
    ),
  ...
  $form['mtt_settings']['font_tab']['font']['sitename_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Site name'),
    '#default_value' => theme_get_setting('sitename_font_family', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['font_tab']['font']['slogan_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Slogan'),
    '#default_value' => theme_get_setting('slogan_font_family', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['font_tab']['font']['headings_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Headings'),
    '#default_value' => theme_get_setting('headings_font_family', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['font_tab']['font']['headings_wide_spacing'] = array(
    ...
    '#default_value' => theme_get_setting('headings_wide_spacing', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['font_tab']['font']['paragraph_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Paragraph'),
    '#default_value' => theme_get_setting('paragraph_font_family', 'slren'),
    '#options' => array(
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['rs_slideshow_fullscreen_effect'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullscreen_effect', 'slren'),
    '#options' => array(
      'fade' => t('Fade'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['rs_slideshow_fullscreen_effect_time'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullscreen_effect_time', 'slren'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['rs_slideshow_fullscreen_navigation_style'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullscreen_navigation_style', 'slren'),
    '#options' => array(
      'bullets' => t('Bullets'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['rs_slideshow_fullscreen_bullets_position'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullscreen_bullets_position', 'slren'),
    '#options' => array(
      'left' => t('Left'),
      'right' => t('Right'),
    ),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['rs_slideshow_fullscreen_touch_swipe'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullscreen_touch_swipe', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['transparent_header_state'] = array(
    ...
    '#default_value' => theme_get_setting('transparent_header_state', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['transparent_header_opacity'] = array(
    ...
    '#default_value' => theme_get_setting('transparent_header_opacity', 'slren'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen']['inverted_header_state'] = array(
    ...
    '#default_value' => theme_get_setting('inverted_header_state', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_effect'] = array(
    ...
    '#title' => t('Effects'),
    '#description'   => t('From the drop-down menu, select the slideshow effect you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_effect', 'slren'),
    '#options' => array(
    'fade' => t('Fade'),
      'slideup' => t('Slide To Top'),
      'slidedown' => t('Slide To Bottom'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_initial_height'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_initial_height', 'slren'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_navigation_style'] = array(
    ...
    '#title' => t('Navigation Style'),
    '#description'   => t('From the drop-down menu, select the style you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_navigation_style', 'slren'),
    '#options' => array(
      'bullets' => t('Bullets'),
      'titles_carousel' => t('Titles Carousel'),
    ),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_bullets_position'] = array(
    ...
    '#title' => t('Navigation bullets position'),
    '#description'   => t('From the drop-down menu, select the position you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_bullets_position', 'slren'),
    '#options' => array(
      'left' => t('Left'),
      'center' => t('Center'),
      'right' => t('Right'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullwidth']['rs_slideshow_fullwidth_touch_swipe'] = array(
    ...
    '#title' => t('Enable Touch Swipe Navigation'),
    '#description'   => t('Use the checkbox to enable or disable touch swipe navigation in mobile devices.'),
    '#default_value' => theme_get_setting('rs_slideshow_fullwidth_touch_swipe', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_effect'] = array(
    ...
    '#title' => t('Effects'),
    '#description'   => t('From the drop-down menu, select the slideshow effect you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_effect', 'slren'),
    '#options' => array(
      'fade' => t('Fade'),
      'slideup' => t('Slide To Top'),
      'slidedown' => t('Slide To Bottom'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_initial_height'] = array(
    '#type' => 'textfield',
    '#title' => t('Initial Height (px)'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_initial_height', 'slren'),
    '#description'   => t('Set the initial height, in pixels.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_navigation_style'] = array(
    ...
    '#title' => t('Navigation Style'),
    '#description'   => t('From the drop-down menu, select the style you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_navigation_style', 'slren'),
    '#options' => array(
      'bullets' => t('Bullets'),
      'titles_carousel' => t('Titles Carousel'),
    ),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_bullets_position'] = array(
    ...
    '#title' => t('Navigation bullets position'),
    '#description'   => t('From the drop-down menu, select the position you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_bullets_position', 'slren'),
    '#options' => array(
      'left' => t('Left'),
      'center' => t('Center'),
      'right' => t('Right'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_boxedwidth']['rs_slideshow_boxedwidth_touch_swipe'] = array(
    ...
    '#title' => t('Enable Touch Swipe Navigation'),
    '#description'   => t('Use the checkbox to enable or disable touch swipe navigation in mobile devices.'),
    '#default_value' => theme_get_setting('rs_slideshow_boxedwidth_touch_swipe', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_effect'] = array(
    ...
    '#title' => t('Effects'),
    '#description'   => t('From the drop-down menu, select the slideshow effect you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_effect', 'slren'),
    '#options' => array(
      'fade' => t('Fade'),
      'slideup' => t('Slide To Top'),
      'slidedown' => t('Slide To Bottom'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_initial_height'] = array(
    '#type' => 'textfield',
    '#title' => t('Initial Height (px)'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_initial_height', 'slren'),
    '#description'   => t('Set the initial height, in pixels.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_navigation_style'] = array(
    ...
    '#title' => t('Navigation Style'),
    '#description'   => t('From the drop-down menu, select the style you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_navigation_style', 'slren'),
    '#options' => array(
      'bullets' => t('Bullets'),
      'titles_carousel' => t('Titles Carousel'),
    ),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_bullets_position'] = array(
    ...
    '#title' => t('Navigation bullets position'),
    '#description'   => t('From the drop-down menu, select the position you prefer.'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_bullets_position', 'slren'),
    '#options' => array(
      'left' => t('Left'),
      'center' => t('Center'),
      'right' => t('Right'),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_internal']['rs_slideshow_internal_touch_swipe'] = array(
    ...
    '#title' => t('Enable Touch Swipe Navigation'),
    '#description'   => t('Use the checkbox to enable or disable touch swipe navigation in mobile devices.'),
    '#default_value' => theme_get_setting('rs_slideshow_internal_touch_swipe', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['rs_global']['rs_slideshow_caption_opacity'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_caption_opacity', 'slren'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['rs_global']['rs_slideshow_background_opacity'] = array(
    ...
    '#default_value' => theme_get_setting('rs_slideshow_background_opacity', 'slren'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['in_page_slider']['in_page_slider_effect'] = array(
    ...
    '#title' => t('Effects'),
    '#description'   => t('From the drop-down menu, select the slideshow effect you prefer.'),
    '#default_value' => theme_get_setting('in_page_slider_effect', 'slren'),
    '#options' => array(
    'fade' => t('fade'),
    'slide' => t('slide'),
    ),
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_products']['owl_products_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_products_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_products']['owl_products_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_products_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_team_members']['owl_team_members_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_team_members_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_team_members']['owl_team_members_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_team_members_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_promoted_posts']['owl_promoted_posts_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_promoted_posts_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_promoted_posts']['owl_promoted_posts_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_promoted_posts_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_articles']['owl_articles_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_articles_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_articles']['owl_articles_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_articles_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_testimonials']['owl_testimonials_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_testimonials_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_testimonials']['owl_testimonials_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_testimonials_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_related_nodes']['owl_related_nodes_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_related_nodes_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_related_nodes']['owl_related_nodes_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_related_nodes_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_brands']['owl_brands_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_brands_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_brands']['owl_brands_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_brands_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_collections']['owl_collections_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_collections_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_collections']['owl_collections_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_collections_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_service_categories']['owl_service_categories_autoplay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Autoplay'),
    '#default_value' => theme_get_setting('owl_service_categories_autoplay', 'slren'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['carousel']['owl_service_categories']['owl_service_categories_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('owl_service_categories_effect_time', 'slren'),
    '#description'   => t('Set the speed of animations, in seconds.'),
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_offset'] = array(
    ...
    '#default_value' => theme_get_setting('in_page_navigation_offset', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['banner_id'] = array(
    ...
    '#default_value' => theme_get_setting('banner_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['content_top_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('content_top_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['content_top_highlighted_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('content_top_highlighted_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['main_content_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('main_content_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['content_bottom_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('content_bottom_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['featured_top_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('featured_top_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['featured_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('featured_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['featured_bottom_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('featured_bottom_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['sub_featured_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('sub_featured_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['highlighted_top_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('highlighted_top_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['highlighted_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('highlighted_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['footer_top_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('footer_top_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['footer_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('footer_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['footer_bottom_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('footer_bottom_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['in_page_navigation']['in_page_navigation_settings']['in_page_navigation_regions']['subfooter_id'] = array(
    ...
    '#description'   => t('Specify the id attribute of the region. This value must be unique.'),
    '#default_value' => theme_get_setting('subfooter_id', 'slren'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['isotope_tab']['isotope_layout_mode'] = array(
    ...
    '#default_value' => theme_get_setting('isotope_layout_mode', 'slren'),
    '#description'   => t('From the drop-down menu, select the layout mode you prefer.'),
    '#options' => array(
      'masonry' => t('Masonry'),
      'fitRows' => t('Fit Rows'),
  ...
  $form['mtt_settings']['isotope_tab']['isotope_filters_text'] = array(
    ...
    '#default_value' => theme_get_setting('isotope_filters_text', 'slren'),
  ...
  $form['mtt_settings']['google_maps_tab']['google_maps_key'] = array(
    ...
    '#default_value' => theme_get_setting('google_maps_key','slren'),
    '#size'          => 50,
    '#maxlength'     => 50,
  );
