    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.slren.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.slren.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
