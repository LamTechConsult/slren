    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-articles').once('mtOwlCarouselArticlesInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.slren.owlCarouselArticlesInit.owlArticlesAutoPlay,
          autoplayTimeout: drupalSettings.slren.owlCarouselArticlesInit.owlArticlesEffectTime,
          nav: true,
          dots: true,
          loop: true,
