jQuery(document).ready(function($) {
  ...
  filtersMasonry.prepend( "<li class=\"active\"><a href=\"#\" data-filter=\"*\">" + drupalSettings.slren.isotopeFiltersGridInit.isotopeFiltersText + "</a></li>" );
  ...
  masonryContainer.imagesLoaded(function() {
    masonryContainer.isotope({
      ...
      layoutMode : drupalSettings.slren.isotopeFiltersGridInit.isotopeLayoutMode,
