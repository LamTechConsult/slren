    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-promoted-posts').once('mtowlCarouselPromotedPostsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.slren.owlCarouselPromotedPostsInit.owlPromotedPostsAutoPlay,
          autoplayTimeout: drupalSettings.slren.owlCarouselPromotedPostsInit.owlPromotedPostsEffectTime,
          nav: true,
          dots: false,
          loop: true,
