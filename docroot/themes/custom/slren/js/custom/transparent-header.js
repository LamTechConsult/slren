  ...
  Drupal.behaviors.mtTransparentHeader = {
    attach: function (context, settings) {
      ...
      if ($('header.header', context)) {
        var header_color = $(".header-container.js-transparent-header header.header").css("background-color").replace(")", "," + drupalSettings.slren.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
        $(".header-container.js-transparent-header header.header").css("background-color", header_color);
      }

      if ($('.header-top', context)) {
        var header_top_color = $(".header-container.js-transparent-header .header-top").css("background-color").replace(")", "," + drupalSettings.slren.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
